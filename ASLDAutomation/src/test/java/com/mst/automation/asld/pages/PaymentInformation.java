...
public class PaymentInformation {
	...
	public static void verifyValue(WebElement ElementID, String value) throws Exception {
		...
		if (portaldata.equals(ExpectedData)) {
			Report.testStepStatus("Value mached", "Pass", "Payment field value is " + ExpectedData + " and Record value is " + portaldata + " both are same verified");
		} else {
			Report.testStepStatus("Value not mached", "Fail", "Payment field value is " + ExpectedData + " and Record value is " + portaldata + "both are different not verified");
		}
	}
}
